...
public class NotificationDetails extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            String notification_details = rs.getString(rs.getColumnIndex(SQLiteDB.NOTIFICATION_DETAILS));
        }
        catch (Exception e)
        {
        ...
        /**try {
            ...
            rs.moveToFirst();
            String notification_details = rs.getString(rs.getColumnIndex(SQLiteDB.NOTIFICATION_DETAILS));
            final TextView notification_text = (TextView) findViewById(R.id.notification_details);
            notification_text.setText(notification_details);
        }catch (Exception e)
        {
            Toast.makeText(NotificationDetails.this,"Unable to retrieve from SQLite DB",Toast.LENGTH_SHORT).show();
        }**/
